...
public class JSONParserForPlaces implements JSONParser<List<HashMap<String, String>>> {
	
	@Override
	public List<HashMap<String,String>> getParsedDataFromJson(JSONObject jObject){		
